 ...
 */
public class AddLinesActivityOld extends AppCompatActivity implements FragmentIterationListener, View.OnClickListener {

    public static final String TAG = AddLinesActivityOld.class.getSimpleName();
...
//                Toast.makeText(AddLinesActivityOld.this,"Selected page position: " + position, Toast.LENGTH_SHORT).show();
