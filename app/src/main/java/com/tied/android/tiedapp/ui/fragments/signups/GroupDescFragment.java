...
public class GroupDescFragment extends Fragment implements View.OnClickListener{
    ...
    private RadioGroup desc_rep_type;
    ...
    public void initComponent(View view) {
        ...
        desc_rep_type = (RadioGroup) view.findViewById(R.id.desc_rep_type);
    ...
    public boolean validated(){
        int radioButtonID = desc_rep_type.getCheckedRadioButtonId();
        RadioButton radioButton = (RadioButton) desc_rep_type.findViewById(radioButtonID);
        descText = radioButton.getText().toString();
        return !descText.equals("");
    }
    ...
    public void continue_action(){
        if(validated()){
            ...
            user.setGroup_description(descText);
