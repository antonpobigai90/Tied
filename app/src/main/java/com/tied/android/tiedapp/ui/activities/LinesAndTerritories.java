...
public class LinesAndTerritories extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinesFragment linesFragment=(LinesFragment)LinesFragment.newInstance(getIntent().getExtras());
        MyUtils.addFragment(ft, null, linesFragment , LinesFragment.class.getName());
/**
