 ...
 */
public class CoworkerScheduleFragment extends SchedulesFragment{

    public static final String TAG = CoworkerScheduleFragment.class
            .getSimpleName();
    int page=1;
    Parcelable mListViewState;
    public CoworkerScheduleFragment() {
        super();
    }
